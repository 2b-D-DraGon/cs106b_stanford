...
bool isPathToFreedomRec(MazeCell* start, const string& moves,Set<Item> &owned) {
    ...
    if(moves[0]=='E'){
        if(start->east!=nullptr){
            if(start->whatsHere!=Item::NOTHING){
                owned.add(start->whatsHere);
                return isPathToFreedomRec(start->east,moves.substr(1),owned);
            }
            else{
                return isPathToFreedomRec(start->east,moves.substr(1),owned);
            }
    ...
    if(moves[0]=='N'){
        if(start->north!=nullptr){
            if(start->whatsHere!=Item::NOTHING){
                owned.add(start->whatsHere);
                return isPathToFreedomRec(start->north,moves.substr(1),owned);
            }
            else{
                return isPathToFreedomRec(start->north,moves.substr(1),owned);
            }
    ...
    if(moves[0]=='W'){
        if(start->west!=nullptr){
            if(start->whatsHere!=Item::NOTHING){
                owned.add(start->whatsHere);
                return isPathToFreedomRec(start->west,moves.substr(1),owned);
            }
            else{
                return isPathToFreedomRec(start->west,moves.substr(1),owned);
            }
    ...
    if(moves[0]=='S'){
        if(start->south!=nullptr){
            if(start->whatsHere!=Item::NOTHING){
                owned.add(start->whatsHere);
                return isPathToFreedomRec(start->south,moves.substr(1),owned);
            }
            else{
                return isPathToFreedomRec(start->south,moves.substr(1),owned);
            }
...
bool isPathToFreedom(MazeCell* start, const string& moves) {
    ...
    return isPathToFreedomRec(start,moves,owned);
}
