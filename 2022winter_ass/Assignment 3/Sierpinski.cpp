...
void drawSierpinskiTriangle(GWindow& window,
    ...
    if(order==0){
        ...
        error(" order is negetive");
    }
    else{
        drawSierpinskiTriangle(window,(x0+x1)/2.0,(y0+y1)/2.0,(x0+x2)/2.0,(y0+y2)/2.0,x0,y0,order-1);
        drawSierpinskiTriangle(window,(x0+x2)/2.0,(y0+y2)/2.0,(x2+x1)/2.0,(y2+y1)/2.0,x2,y2,order-1);
        drawSierpinskiTriangle(window,(x0+x1)/2.0,(y0+y1)/2.0,(x2+x1)/2.0,(y2+y1)/2.0,x1,y1,order-1);
    }
}
